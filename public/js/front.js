  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios.get("http://127.0.0.1:8000/api/posts").then(function (result) {
        ...
        console.log(_this.posts = result.data.result);
...
var render = function () {
  ...
  return _c("header", [
    _c(
      "nav",
      { staticClass: "navbar navbar-expand-lg navbar-light bg-warning" },
      [
        _c(
          "div",
            ...
            _c("div", { staticClass: "card-body" }, [
              ...
              _c("p", { staticClass: "card-text" }, [
                _c("small", { staticClass: "text-muted" }, [
                  _vm._v("Last updated " + _vm._s(_vm.post.created_at)),
                ]),
              ]),
            ]),
          ]),
...
module.exports = __webpack_require__(/*! C:\EserciziClasse55\Esercizi\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
